...
public class ReadReportActivity extends BaseActivity implements
...
//				startActivity(intent);
	...
	private void initView() {
		...
		bookSelf = (ImageButton) (findViewById(R.id.top)
				.findViewById(R.id.ib_bg_bookshelf));
		bookSelf.setOnClickListener(this);
		back = (ImageButton) (findViewById(R.id.top)
				.findViewById(R.id.ib_bg_back));
