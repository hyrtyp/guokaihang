...
//		PersonCenter.this.finish();
	...
	public void onClick(View v) {
		...
		case R.id.person_info:
			...
			qccount_info.setBackgroundResource(R.drawable.grzx_2_2);
			change_password.setBackgroundResource(R.drawable.grzx_2_3);
		...
		case R.id.qccount_info:
			person_info.setBackgroundResource(R.drawable.grzx_2_1);
			qccount_info.setBackgroundResource(R.drawable.grzx_1_2);
			change_password.setBackgroundResource(R.drawable.grzx_2_3);
		...
		case R.id.change_password:
			person_info.setBackgroundResource(R.drawable.grzx_2_1);
			qccount_info.setBackgroundResource(R.drawable.grzx_2_2);
			change_password.setBackgroundResource(R.drawable.grzx_1_3);
