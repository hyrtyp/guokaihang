    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                ScrollView scrollView = (ScrollView) ((Activity)this.context).findViewById(com.hyrt.cei.R.id.sun_scrollview);
					 scrollView.scrollBy((int) (lastX - ev.getX()), (int) (lastY - ev.getY()));
                setLastPosition(ev);
                break;
