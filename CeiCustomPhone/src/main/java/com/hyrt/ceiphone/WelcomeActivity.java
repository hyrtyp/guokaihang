	...
	private Handler handler = new Handler() {
		...
		public void dispatchMessage(Message msg) {
			...
			case IS_NET:
				...
				builder.create().show();
//				SharedPreferences settings2 = getSharedPreferences("loginInfo",
//						Activity.MODE_PRIVATE);
//				SharedPreferences.Editor editor2 = settings2.edit();
//				editor2.putString("LOGINNAME1", "");
//				editor2.putString("PASSWORD1", "");
//				editor2.commit();
//				Toast.makeText(WelcomeActivity.this, "网络不通", Toast.LENGTH_SHORT).show();
...
//				editor1.commit();
			...
			case USER_ERROR:
				...
				errorUserBuilder.setMessage("用户名密码错误,请点确认重新登录！");
